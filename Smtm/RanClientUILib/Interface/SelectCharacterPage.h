...
public:
	...
	CUIControl*			m_pCharacterClassPos1[GLCI_NUM_2012];
	CUIControl*			m_pCharacterClassSetPos1[GLCI_NUM_2012];

	CUIControl*			m_pCharacterClassPos2[GLCI_NUM_2012];
	CUIControl*			m_pCharacterClassSetPos2[GLCI_NUM_2012];

	CUIControl*			m_pCharacterClassPos3[GLCI_NUM_2012];
	CUIControl*			m_pCharacterClassSetPos3[GLCI_NUM_2012];

	CUIControl*			m_pCharacterClassPos4[GLCI_NUM_2012];
	CUIControl*			m_pCharacterClassSetPos4[GLCI_NUM_2012];
