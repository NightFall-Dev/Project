...
void CPartySlot::CreateSubControl ()
{
	...
	CString strClassLive[GLCI_NUM_2012] =
	{
		...
		"PARTY_INFO_MAGICIAN_MALE_LIVE",
		"PARTY_INFO_MAGICIAN_FEMALE_LIVE",
	};

	CString strClassDie[GLCI_NUM_2012] =
	{
		...
		"PARTY_INFO_MAGICIAN_MALE_DIE",
		"PARTY_INFO_MAGICIAN_FEMALE_DIE",
	};
...
{
	if ( nClass < GLCI_FIGHTER_M && nClass > GLCI_MAGICIAN_W ) return;
