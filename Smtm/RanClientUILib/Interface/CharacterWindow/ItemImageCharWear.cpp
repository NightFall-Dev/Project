...
{	
 ...
 // Add Colorazation Per Ups  Kun :D 
	if ( m_pTextBox && nGrind >= 1 && nGrind <= 4 ){
		...
		m_pTextBox->SetOneLineText( strGrind.GetString(),NS_UITEXTCOLOR::WHITE );
		...
		CString strGrind;
		strGrind.Format( "+%d", nGrind );
		m_pTextBox->SetOneLineText( strGrind.GetString(),NS_UITEXTCOLOR::AQUA );
		...
		strGrind.Format( "+%d", nGrind );
		m_pTextBox->SetOneLineText( strGrind.GetString(),NS_UITEXTCOLOR::VIOLET );
	}else if ( m_pTextBox && nGrind == 13 ){
		CString strGrind;
		strGrind.Format( "+%d", nGrind );
		m_pTextBox->SetOneLineText( strGrind.GetString(),NS_UITEXTCOLOR::PINK );
	}else if ( m_pTextBox && nGrind == 14 ){ 
		CString strGrind;
		strGrind.Format( "+%d", nGrind );
		m_pTextBox->SetOneLineText( strGrind.GetString(),NS_UITEXTCOLOR::GREEN );
	}else if ( m_pTextBox && nGrind == 15 ){ 
		CString strGrind;
		strGrind.Format( "+%d", nGrind );
