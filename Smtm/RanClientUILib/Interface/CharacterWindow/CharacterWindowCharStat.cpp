...
void CCharacterWindowCharStat::CreateSubControl ()
{
	...
	//stats buttons
	m_pPowButton_Plus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_POW_PLUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_POW_BUTTON_PLUS, "+" );		
	m_pDexButton_Plus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_DEX_PLUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_DEX_BUTTON_PLUS, "+" );
	m_pSpiButton_Plus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_SPI_PLUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_SPI_BUTTON_PLUS, "+" );
	m_pStrButton_Plus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_STR_PLUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_STR_BUTTON_PLUS, "+" );
	m_pStaButton_Plus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_STA_PLUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_STA_BUTTON_PLUS, "+" );
	m_pPowButton_Minus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_POW_MINUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_POW_BUTTON_MINUS, "-" );		
	m_pDexButton_Minus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_DEX_MINUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_DEX_BUTTON_MINUS, "-" );
	m_pSpiButton_Minus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_SPI_MINUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_SPI_BUTTON_MINUS, "-" );
	m_pStrButton_Minus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_STR_MINUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_STR_BUTTON_MINUS, "-" );
	m_pStaButton_Minus = CreateButtonBlue ( "CHARACTER_WINDOW_STAT_STA_MINUS_BUTTON", "CHARACTER_WINDOW_STAT_BUTTON_TEXT_POS", pFont2, nAlignCenterBoth, CHARACTER_STA_BUTTON_MINUS, "-" );
...
void CCharacterWindowCharStat::SetData( const GLCHARLOGIC& sCharData )
{
	...
	if ( m_pAttackMinText ) m_pAttackMinText->SetOneLineText ( strCombine, NS_UITEXTCOLOR::SILVER );

	strCombine.Format ( "%d", sCharData.GETFORCE_HIGH () );
	if ( m_pAttackMaxText ) m_pAttackMaxText->SetOneLineText ( strCombine, NS_UITEXTCOLOR::SILVER );
	...
	if ( m_pFightText ) m_pFightText->SetOneLineText ( strCombine, NS_UITEXTCOLOR::SILVER );

	strCombine.Format ( "%d", sCharData.m_wSUM_SA );
	if ( m_pShootText ) m_pShootText->SetOneLineText ( strCombine, NS_UITEXTCOLOR::SILVER );

	strCombine.Format ( "%d", sCharData.m_wSUM_MA );
	if ( m_pEnergyText ) m_pEnergyText->SetOneLineText ( strCombine, NS_UITEXTCOLOR::SILVER );

	strCombine.Format ( "%d", sCharData.GETHIT () );
	if ( m_pHitText ) m_pHitText->SetOneLineText ( strCombine, NS_UITEXTCOLOR::SILVER );

	strCombine.Format ( "%d", sCharData.GETAVOID () );
	if ( m_pAvoidText ) m_pAvoidText->SetOneLineText ( strCombine, NS_UITEXTCOLOR::SILVER );
