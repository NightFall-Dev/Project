...
void CItemMixItems::LoadItemMixItems ( const ITEM_MIX& sItemMix )
{
	...
	switch ( pItemData->sBasicOp.emLevel )
	{
		...
		case LEVEL_VERYRARE:		{	dwTextColor = NS_UITEXTCOLOR::VERYRARE;	}	break;
		case LEVEL_EPIC:			{	dwTextColor = NS_UITEXTCOLOR::EPIC;		}	break;
		case LEVEL_UNIQUE:			{	dwTextColor = NS_UITEXTCOLOR::UNIQUE;		}	break;
