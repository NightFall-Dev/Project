...
//			ResetResiIcon ();
		...
		//	기본 정보
		{
			...
			//add class "MAGICIAN"
			if (( pSkill->m_sLEARN.dwCLASS & GLCC_MAGICIAN_M )&&
			 ( pSkill->m_sLEARN.dwCLASS & GLCC_MAGICIAN_W ))	strText.Format ( "Magician/");
		...
		}
		{
			...
			AddTextNoSplit ( strText1, NS_UITEXTCOLOR::LIGHTCYAN );
		}
