...
if ( pChar )
{
	if ( pChar->m_wSchool == 0 )
	{
		...
		GLMSG::SNET_SW_TOWERDOWN NetMsg;
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERSG )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_SG;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 0;
		}
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERPHX )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_SGPHX;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 0;
		}
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERMP )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_SGMP;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 0;
		}
	...
	else if(pChar->m_wSchool == 1 )
	{
		...
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERSG )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_MPSG;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 1;
		}
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERPHX )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_MPPHX;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 1;
		}
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERMP )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_MP;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 1;
		}
	...
	else if(pChar->m_wSchool == 2 )
	{
		...
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERSG )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_PHXSG;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 2;
		}
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERPHX )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_PHX;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 2;
		}
		if ( m_pCrowData->m_sAction.m_dwActFlag&EMCROWACT_TOWERMP )
		{
				bool bOn(false);
				bOn = true;
				NetMsg.emFB = EMTOWER_DESTROYED_PHXMP;
				NetMsg.bOn = bOn;
				NetMsg.emSchool = 2;
			}
		GLGaeaServer::GetInstance().SENDTOAGENT( pChar->m_dwClientID,&NetMsg );
