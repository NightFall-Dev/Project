...
HRESULT GLChar::MsgReqInvenDrug ( NET_MSG_GENERIC* nmg )
{
	...
	case ITEM_DRUG_CURE:
	case ITEM_DRUG_ANTI_POTS:
	case ITEM_DRUG_ANTI_SKILL:
	case ITEM_DRUG_ANTI_STUN:
...
HRESULT GLChar::MsgReqInvenGenderChange( NET_MSG_GENERIC* nmg )
{
	...
	else if ( m_emClass == GLCC_EXTREME_M || m_emClass == GLCC_SCIENCE_M || m_emClass == GLCC_ASSASIN_M || m_emClass == GLCC_MAGICIAN_M )  emClass = (EMCHARCLASS) (m_emClass * 2 );
	else if ( m_emClass == GLCC_EXTREME_W || m_emClass == GLCC_SCIENCE_W || m_emClass == GLCC_ASSASIN_W || m_emClass == GLCC_MAGICIAN_W )  emClass = (EMCHARCLASS) (m_emClass / 2 );
