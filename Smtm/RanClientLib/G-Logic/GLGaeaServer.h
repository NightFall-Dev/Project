...
struct SCLASSEVENTDATA
{
	...
	float fItemGainRate[GLCI_NUM_2012];
	float fExpGainRate[GLCI_NUM_2012];
	float fMoneyGainRate[GLCI_NUM_2012];

	DWORD dwExpMinLevel[GLCI_NUM_2012];
	DWORD dwExpMaxLevel[GLCI_NUM_2012];
	DWORD dwItemMinLevel[GLCI_NUM_2012];
	DWORD dwItemMaxLevel[GLCI_NUM_2012];
	DWORD dwMoneyMinLevel[GLCI_NUM_2012];
	DWORD dwMoneyMaxLevel[GLCI_NUM_2012];
