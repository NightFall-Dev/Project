...
enum EMCHARCLASS
{
	...
	//add class "MAGICIAN"
	GLCC_MAGICIAN_M	= 0x4000,
	GLCC_MAGICIAN_W	= 0x8000,
	//
	...
	//add class "MAGICIAN"
	GLCC_MAGICIAN	= ( GLCC_MAGICIAN_M | GLCC_MAGICIAN_W ),
	//
	...
	GLCC_ALL_NEWSEX	= (GLCC_FIGHTER_M | GLCC_FIGHTER_W | GLCC_ARMS_M | GLCC_ARMS_W | GLCC_ARCHER_M | GLCC_ARCHER_W | GLCC_SPIRIT_M | GLCC_SPIRIT_W | GLCC_EXTREME_M | GLCC_EXTREME_W),

	//add class "SCIENCE", "ASSASSIN", "MAGICIAN"
	GLCC_ALL_2012	= (GLCC_FIGHTER_M | GLCC_FIGHTER_W | GLCC_ARMS_M | GLCC_ARMS_W | GLCC_ARCHER_M | GLCC_ARCHER_W | GLCC_SPIRIT_M | GLCC_SPIRIT_W | GLCC_EXTREME_M | GLCC_EXTREME_W| GLCC_SCIENCE_M | GLCC_SCIENCE_W | GLCC_ASSASIN_M | GLCC_ASSASIN_W | GLCC_MAGICIAN_M | GLCC_MAGICIAN_W ),
					//
	...
	//add class "SCIENCE", "ASSASSIN", "MAGICIAN"
	GLCC_MAN		= (GLCC_FIGHTER_M | GLCC_ARMS_M | GLCC_ARCHER_M | GLCC_SPIRIT_M | GLCC_EXTREME_M | GLCC_SCIENCE_M | GLCC_ASSASIN_M | GLCC_MAGICIAN_M),
	GLCC_WOMAN		= (GLCC_FIGHTER_W | GLCC_ARMS_W | GLCC_ARCHER_W | GLCC_SPIRIT_W | GLCC_EXTREME_W | GLCC_SCIENCE_W | GLCC_ASSASIN_W | GLCC_MAGICIAN_W),
};
...
namespace COMMENT
{
	...
	//add class "SCIENCE", "ASSASSIN", "MAGICIAN"
	extern std::string CHARCLASS[GLCI_NUM_2012];

	extern std::string EMSCHOOL[GLSCHOOL_NUM];

	//extern std::string CHARCOMMENT[GLCI_NUM_NEWSEX];
	//add class "SCIENCE", "ASSASSIN", "MAGICIAN"
	extern std::string CHARCOMMENT[GLCI_NUM_2012];
